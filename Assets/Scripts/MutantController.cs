...
public class MutantController : EnemyController {
    ...
    public GameObject mutantPickUp;
    ...
    public void KillMe()
    {
        Instantiate(mutantPickUp, (this.gameObject.transform.position + (new Vector3(-0.2f, 0.0f, 0.0f))), this.gameObject.transform.rotation);
